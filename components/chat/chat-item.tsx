        ...
        <div className="flex flex-col w-full">
          ...
          {!fileUrl && isEditing && (
            <Form {...form}>
              ...
              <span className="text-[10px] mt-1 text-zinc-100">
      ...
      {canDeleteMessage && (
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounded-sm">
          ...
          <ActionTooltip label="Delete">
            <Trash className="cursor-pointer ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400 transition" />
          </ActionTooltip>
        </div>
      )}
    </div>
